      ...
      <div className="h-screen">
        {isMobile && (
          <motion.div
            ...
            className="fixed left-[50%] translate-x-[-50%] w-[90%] flex items-center justify-center text-white font-semibold  sm:top-2 md:bottom-12 gap-2 rounded-lg lg:bottom-2  bg-sky-500 border-2 px-2 py-2 shadow-xl"
          >
